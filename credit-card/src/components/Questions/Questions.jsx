...
export const Questions = ({
  ...
  return (
    <div className="ques bg-[#edeae7] w-[90%] rounded-lg flex flex-col items-center justify-center py-10 shadow-md mt-14 ml-20 mb-10">
      <Toaster theme="dark" />
      ...
      <div className="form bg-white w-[80%] rounded-lg shadow-lg p-6 mt-6 flex flex-col gap-6">
        <p>Premium Spending: ₹{premium}</p>
        <p>All Purpose Spending: ₹{allPurpose}</p>
        <p>Lifestyle Spending: ₹{lifestyle}</p>
        <p>Fuel Spending: ₹{fuel}</p>
        <p>Travel Spending: ₹{travel}</p>
          ...
          <div className="flex gap-6 mt-2">
            <label className="flex items-center space-x-2">
              <input
                ...
                name="travel"
                className="w-5 h-5"
                onChange={() => setFrequentTraveler(1)}
              />
              <span>Yes</span>
            </label>
            <label className="flex items-center space-x-2">
              <input
                ...
                name="travel"
                className="w-5 h-5"
                onChange={() => setFrequentTraveler(0)}
              />
              <span>No</span>
            </label>
          </div>
      ...
      <div className="flex justify-center gap-6 mt-6">
        <button
          className="bg-[#C49991] text-white py-2 px-6 rounded-lg hover:bg-gray-500 transition"
          onClick={() => navigate(-1)} // Go back to Income component
        >
          Back
        </button>
        <button
